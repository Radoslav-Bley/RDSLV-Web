...
var currentPageLanguage = window.location.pathname.includes('/sk/index.html') ? 'sk' : 'en';

if (sessionStorage.getItem('selectedLanguage') !== currentPageLanguage) { // Use sessionStorage instead of localStorage
  if (userLang == 'sk' || userLang == 'cs') {
    languageMessage.textContent = 'Váš systémový jazyk je nastavený na Slovenský/Český jazyk. Prajete si zobraziť stránku vo Vašom jazyku?';
    languageSelector.style.display = 'block';
    mainContent.classList.add('with-language-selector');
  } else {
    languageMessage.textContent = 'Your system language is set to English. Would you like to view the page in your language?';
    languageSelector.style.display = 'block';
    mainContent.classList.add('with-language-selector');
  }
}
